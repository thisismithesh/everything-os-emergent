  ...
  return (
    <>
      <PageHeader eyebrow="Calendar" title={monthLabel} description="Project events, company events, and team leaves.">
        ...
        <a href={`${process.env.REACT_APP_BACKEND_URL}/api/export/events.csv`} data-testid="calendar-export-btn" className="ml-2 px-3 py-2 rounded-md border border-[var(--border-default)] hover:bg-[var(--bg-surface-hover)] text-sm flex items-center gap-2"><Download className="w-4 h-4" /> Export</a>
        {canEdit && (
