  ...
  return (
    <>
      <PageHeader eyebrow="Clients" title="Clients" description="Companies, contacts, and active projects.">
        <a href={`${import.meta.env.VITE_BACKEND_URL}/api/export/clients.csv`} className="px-3 py-2 rounded-md border border-[var(--border-default)] hover:bg-[var(--bg-surface-hover)] text-sm flex items-center gap-2" data-testid="clients-export-btn">
