  ...
  return (
    <>
      <PageHeader eyebrow="Projects" title="Projects" description="Active engagements, retainers and internal work.">
        ...
        <a href={`${import.meta.env.VITE_BACKEND_URL}/api/export/projects.csv`} className="px-3 py-2 rounded-md border border-[var(--border-default)] hover:bg-[var(--bg-surface-hover)] text-sm flex items-center gap-2" data-testid="projects-export-btn">
